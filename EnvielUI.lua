...
function EnvielUI:CreateWindow(Config)
	...
	local Footer = Create("TextLabel", {
		...
		Text = "Made by Enviel", TextSize = 10, FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal), TextColor3 = self.Theme.TextSec, TextTransparency = 0
	})
	...
	function Window:SelectTab(TabId)
		...
		for _, btn in pairs(Sidebar:GetChildren()) do
			if btn:IsA("TextButton") and btn.Name ~= TabId.."Btn" then
				...
				btn.FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal)
		...
		if Sidebar:FindFirstChild(TabId.."Btn") then
			...
			if label then
				...
				label.FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
			end
	...
	function Window:CreateTab(Config)
		...
		function Elements:CreateColorPicker(Config)
			...
			Create("TextLabel", {
				...
				FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal), Text=Name, TextColor3=self.Instance.Theme.Text, TextSize=14, TextXAlignment=Enum.TextXAlignment.Left
			})
			...
			local function makeSlider(yPos, Text, InitialVal, UpdateVal)
				local Label = Create("TextLabel", {
					...
					FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal), TextSize = 12
				})
		...
		function Elements:CreateGroup(Config)
			...
			local TitleLbl = Create("TextLabel", {
				...
				Text = Title, FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal), TextSize = 13, TextColor3 = self.Instance.Theme.Text, TextXAlignment = Enum.TextXAlignment.Left
			})
	...
	function Window:Notify(Config)
		...
		local TitleLabel = Create("TextLabel", {
			...
			FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal), Text = TitleText, TextColor3 = self.Instance.Theme.Text,
		...
		local ContentLabel = Create("TextLabel", {
			...
			FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal), Text = ContentText, TextColor3 = self.Instance.Theme.TextSec,
	...
	function Window:Watermark(Config)
		...
		local Text = Create("TextLabel", {
			...
			FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal), TextSize = 11, TextColor3 = self.Instance.Theme.Text,
	...
	function Window:Prompt(Config)
		...
		local TitleLbl = Create("TextLabel", {
			...
			Text = Title, FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal), TextSize = 18, TextColor3 = self.Instance.Theme.Text
		})
		
		local ContentLbl = Create("TextLabel", {
			Parent = PromptFrame, BackgroundTransparency = 1, Size = UDim2.new(1,0,0,0), Position = UDim2.new(0,0,0,30),
			Text = Content, FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal), TextSize = 14, TextColor3 = self.Instance.Theme.TextSec,
		...
		for _, Action in pairs(Actions) do
			local Btn = Create("TextButton", {
				...
				Text = Action.Text, FontFace = Font.new("rbxasset://fonts/families/BuilderSans.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal), TextSize = 13, TextColor3 = self.Instance.Theme.AccentText,
				AutoButtonColor = false
			})
			Create("UICorner", {Parent = Btn, CornerRadius = UDim.new(0, 6)})
